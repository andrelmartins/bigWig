...
author: "André L. Martins, Luther Vucic, and Michael J. Guertin"
date: "`r Sys.Date()`"
output:
...
knitr::include_graphics("../inst/fig/bigWigProbesBp.pdf")
```
...
knitr::include_graphics("../inst/fig/bigWigPlusMinus.pdf")
```
...
knitr::include_graphics("../inst/fig/bwMap.pdf")
```
...
`zeroToOne.scale` sets the minimum value and maximum value of each row to 0 and 1. For every cell the the function applies the formula: $Xn = \dfrac{Xo − min}{max − min}$ \
